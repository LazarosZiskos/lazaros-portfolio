export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 5,
      title: "Currently building an AI powered SaaS application",
  ...
  export const workExperience = [
    {
      ...
      desc: "Designed and developed multiple websites for clients to promote their businesses.",
    ...
    },
    {
      ...
      desc: "Developed an NFT Marketplace web application utilizing API requests to dynamically present data.",
      className: "md:col-span-2", // change to md:col-span-2
      thumbnail: "/exp4.svg",
    },
    {
      id: 4,
      title: "MSc Investment & Finance",
      desc: "Acquired a master's degree in Investment & Finance from the University of Strathclyde, Glasgow.",
      className: "md:col-span-2",
      thumbnail: "/exp3.svg",
    },
  ];
  ...
  export const socialMedia = [
    {
      id: 1,
      img: "/git.svg",
      link:"https://github.com/LazarosZiskos"
    },
    {
      id: 2,
      img: "/link.svg",
      link:"https://www.linkedin.com/in/lazaros-ziskos/"
    },
